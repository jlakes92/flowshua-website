...
const projects={aircraft:{type:'Representative aviation readiness scenario',title:'Aircraft Recovery & Return-to-Service',desc:'A fictional aviation readiness-recovery example focused on maintenance-planning coordination, milestone visibility, documentation, and disciplined return-to-service execution.',tags:['Aviation readiness','Project controls','Return-to-service visibility'],href:'aircraft-return-to-service/',button:'View Aircraft Recovery Case Study'}};
