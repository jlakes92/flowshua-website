...
const projects={aircraft:{type:'Representative aviation readiness scenario',title:'Aircraft Recovery & Return-to-Service',desc:'A representative aviation readiness-recovery example based on founder U.S. Navy aviation experience, focused on maintenance-planning coordination, milestone visibility, documentation, and disciplined return-to-service execution.',tags:['Aviation readiness','Project controls','Return-to-service visibility'],href:'aircraft-return-to-service/',button:'View Aircraft Recovery Case Study'}};
